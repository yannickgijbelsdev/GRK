...
const CookieBanner = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[60] bg-white border-t-4 border-[#062a4a] shadow-2xl animate-in slide-in-from-bottom duration-500">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-5 flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-8">
        <div className="flex-1">
          ...
          <p className="text-[#4a4a4a] text-sm leading-relaxed">
            GRK gebruikt Functionele en Analytische cookies voor websites optimalisatie en metingen. Geef voor andere cookies je voorkeuren op. Social Media cookies kunnen, enkel met jouw toestemming, jouw internetgedrag en voorkeuren bijhouden. <a href="#" className="font-semibold underline text-[#062a4a]">Meer informatie</a>
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-3 flex-shrink-0">
          <button onClick={() => dismiss('more')} className="px-5 py-3 rounded-full text-[#062a4a] font-semibold hover:bg-[#d8e4f0] transition-colors">Meer opties</button>
