  ...
  return (
    <section id="nieuws" className="py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <h2 className="text-[#5a0a2c] text-3xl md:text-4xl font-black mb-10" style={{fontFamily: 'inherit'}}>Nieuws</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {newsItems.map((item) => (
            <a key={item.id} href="#" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-[#f0e0e8] flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="mt-auto flex items-center justify-between">
                  ...
                  <span className="text-xs font-semibold px-3 py-1 rounded-full bg-[#fde2ec] text-[#a02050]">{item.category}</span>
                </div>
              </div>
            </a>
          ))}
