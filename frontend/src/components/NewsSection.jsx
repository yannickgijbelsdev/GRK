  ...
  return (
    <section id="nieuws" className="py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        {showHeader && <h2 className="text-white text-3xl md:text-4xl font-black mb-10">Nieuws</h2>}
        ...
        {showMore && (
          <div className="flex justify-end mt-8">
            <Link to="/nieuws" className="inline-flex items-center gap-2 text-white font-semibold hover:gap-3 transition-all">
              Meer nieuws
