...
const PlaylistSection = ({ limit = 3, showHeader = true, showMore = true, background = true }) => {
  ...
  return (
    <section id="gedraaid" className={`py-16 md:py-20 ${background ? 'bg-[#f9f1f4]' : ''}`}>
      <div className="max-w-4xl mx-auto px-6 lg:px-10">
        {showHeader && <h2 className="text-[#5a0a2c] text-3xl md:text-4xl font-black mb-10">Playlist</h2>}
        ...
        {showMore && (
          <div className="flex justify-end mt-8">
            <Link to="/gedraaid" className="inline-flex items-center gap-2 text-[#5a0a2c] font-semibold hover:gap-3 transition-all">
